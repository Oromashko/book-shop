...
fetch(BOOKS_JSON) //path to the file with json data
   ...
   /*      let divBookCatalogImg = [];
         ...
         for (i=0; i<data.length; i++){
            ...
            divBookCatalogImg[i].addEventListener("dragstart",drag);
            divBookCatalogImg[i].id = "item"+i;
            ...
            pBookAuthor[i].addEventListener("dragstart",drag);
            pBookAuthor[i].id = "item"+i;
            ...
            pBookTitle[i].addEventListener("dragstart",drag);
            pBookTitle[i].id = "item"+i;
            ...
            pBookPrice[i].addEventListener("dragstart", drag);
            pBookPrice[i].id = "item"+i;
